...
class Main extends React.Component {
    state = {
      ...
      componentDidMount() {
        ...
        axios.post(config.server + `/users`, JSON.stringify({ method: 'fetch-all' }))
          .then(res => {
        ...
        <main className="w3-light-grey">
            <div className="w3-main main-w3 ">
                <header className="w3-container" >
                    <h5 style={{marginTop:"20px"}}><b><i className="fa fa-users main-top"></i> Users</b></h5>
                </header>
                            ...
                            <div className="card-body w3-center card-form">
                                ...
                                <form action="#">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select name="user" id="userType" className="custom-select">
