...
class Main extends React.Component {
  ...
  reset() {
    ...
    if (!oldPassword.val() || !passpattern.test(oldPassword.val())) {
    ...
    console.log(data)
    axios.post(config.server + `/forgot`, JSON.stringify(data))
      .then(res => {
        console.log(res);
          ...
          <article>
            ...
            <section className="section contact" aria-labelledby="service-label">
              <div className="container" style={{marginTop: "20px"}}>
                ...
                <p className="section-subtitle" id="service-label">Forgot password?</p>
                ...
                <div className="service-card" >
                  ...
                  <form action="" className="input-wrapper " >
                    ...
                    <input type="password" id="password1"  placeholder="Password" className="input-field"/> 
                    <input type="password" id="password2" placeholder="Confirm password" className="input-field"/>
                    <br/>
                    
                    <div style={{display: "inline-flex"}}>
                      <a href="#" onClick={(e) => this.reset()} className="btn btn-outline" style={{backgroundColor: "hsla(234, 50%, 64%, 1)"}}>Submit</a>
                    </div>
